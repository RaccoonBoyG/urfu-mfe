...
# remove them.
@MFE_APPS.add(priority=urfu_hooks.priorities.HIGH)
...
urfu_hooks.Filters.ENV_TEMPLATE_VARIABLES.add_items(
...
@urfu_hooks.Filters.IMAGES_BUILD_MOUNTS.add()
...
@urfu_hooks.Filters.APP_PUBLIC_HOSTS.add()
...
@urfu_hooks.Filters.IMAGES_BUILD_REQUIRED.add()
